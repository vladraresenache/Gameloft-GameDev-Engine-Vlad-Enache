...
public:
   ...
   void (ESCALLBACK* mouseFunc) (ESContext*, enum MouseButtons, enum MouseEvents, int, int);
...
void ESUTIL_API esRegisterMouseFunc(ESContext* esContext, void (ESCALLBACK* mouseFunc) (ESContext*, enum MouseButtons, enum MouseEvents, int, int));
